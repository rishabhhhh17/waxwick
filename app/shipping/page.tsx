export const metadata = { title: 'Shipping & returns · waxwick' };
    ...
    <div className="bg-cream-50">
      <div className="mx-auto max-w-3xl px-5 md:px-8 py-16 md:py-24 prose prose-neutral">
        ...
        <div className="mt-8 space-y-5 text-clay-700 text-[15.5px] leading-[1.7]">
          ...
          <p><strong className="text-ink">Tracking:</strong> Email <a href="mailto:hello@waxwick.in" className="underline">hello@waxwick.in</a> with your order ID and we’ll send the tracking link.</p>
